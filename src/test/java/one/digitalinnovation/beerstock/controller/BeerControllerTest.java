...
import static one.digitalinnovation.beerstock.converter.JsonConverter.asJsonString;
...
public class BeerControllerTest {
    ...
    private static final String BEER_API_SUBPATH_INCREMENT_URL = "/incrementStock";
    ...
    void whenPATCHIsCalledToIncrementDiscountThenOKstatusIsReturned() throws Exception {
        ...
        doNothing().when(beerService).incrementStock(VALID_BEER_ID, quantityDTO.getQuantity());
    ...
    void whenPATCHIsCalledToIncrementGreatherThanMaxThenBadRequestStatusIsReturned() throws Exception {
        ...
        doThrow(BeerStockExceededException.class)
                .when(beerService).incrementStock(VALID_BEER_ID, quantityDTO.getQuantity());
    ...
    void whenPATCHIsCalledWithInvalidBeerIdToIncrementThenNotFoundStatusIsReturned() throws Exception {
        ...
        doThrow(BeerNotFoundException.class)
                .when(beerService).incrementStock(INVALID_BEER_ID, quantityDTO.getQuantity());

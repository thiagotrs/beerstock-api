...
public class BeerServiceTest {
    ...
    void whenIncrementIsCalledThenIncrementBeerStock() throws BeerNotFoundException, BeerStockExceededException {
        ...
        beerService.incrementStock(expectedBeerDTO.getId(), quantityToIncrement);

        assertThat(expectedBeer.getQuantity(), is(equalTo(expectedQuantityAfterIncrement)));
    ...
    void whenIncrementIsCalledWithInvalidIdThenThrowException() {
        ...
        assertThrows(
                ...
                () -> beerService.incrementStock(INVALID_BEER_ID, quantityToIncrement)
        );
    }
}